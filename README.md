...
6. In Terminal #4, ```rviz``` and set "Keep" parameter to 10,000 to see the trajectory. Other parameters in Rviz can be seen in "qn2_plot_rviz.png" ![alt text](./qn2_plot_rviz_parameters_cropped.png?raw=true "Steps to follow")
